...
export class ServiceFormDialogComponent {
  ...
  postClient() {
    const clientUrl = 'http://13.91.80.87:3000/clientes/cadastro'
  ...
  postService() {
    const serviceUrl = 'http://13.91.80.87:3000/servicos/criar'
  ...
  getCPF() {
    ...
    const cpfURL = `http://13.91.80.87:3000/clientes/cpf/${this.cpfString}`
